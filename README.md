...
[![Minecraft: 1.21.1](https://img.shields.io/badge/Minecraft-1.21.1-green.svg)](https://www.minecraft.net/)
...
- **Vanilla tool fallback**: on Minecraft 1.21.1, tools without explicit config entries fall back to inferring their tier from `ToolMaterial`. This is not available on 1.21.11+ because Minecraft removed the `Tier`/`Tiers` API in favor of data components. On 1.21.11, configure mod tools explicitly via tags or keywords.
